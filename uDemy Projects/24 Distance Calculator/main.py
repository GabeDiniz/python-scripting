...
def main():
  home_address: str = input("Enter From Destination >> ")
  destination_address: str = input("Enter to Destination >> ")

  print("Calculating...")
  get_distance_km(home_address, target=destination_address)
